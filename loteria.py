...
# Sessions variables are stored client-side (on the user's browser.)
# The content of these variables is encrypet, so users can't actually 
...
app.secret_key = "shhhhhhhhhhh! don't tell anyone what I am"
...
def init_game():
	# initialize a new dick (a list of filenames)
